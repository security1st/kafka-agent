 ...
 */
package com.hl.kafkaAgent.cli.commands;
...
public class KafkaAgentCliTestCommand extends AbstractAction {

    private static final Logger LOG = LoggerFactory.getLogger(KafkaAgentCliTestCommand.class);
    protected final KafkaAgentCliCommands service;

    public KafkaAgentCliTestCommand(final KafkaAgentCliCommands service) {
